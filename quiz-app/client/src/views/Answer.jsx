            ...
            <div key={index}>
              ...
              <div className="flex flex-col gap-4">
                <div className="flex gap-4">
                  <input type="radio" name={index} id={`q-${index}-a`} />
                  <label htmlFor={`q-${index}-a`}>{data.answer.a}</label>
                </div>
                <div className="flex gap-4">
                  <input type="radio" name={index} id={`q-${index}-b`} />
                  <label htmlFor={`q-${index}-b`}>{data.answer.b}</label>
                </div>
                <div className="flex gap-4">
                  <input type="radio" name={index} id={`q-${index}-c`} />
                  <label htmlFor={`q-${index}-c`}>{data.answer.c}</label>
                </div>
                <div className="flex gap-4">
                  <input type="radio" name={index} id={`q-${index}-d`} />
